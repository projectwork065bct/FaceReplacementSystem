...
public class Utils {
     ...
     */
    public static final boolean IS_JAVA_1_4 = startsWith(JAVA_VERSION,
            "1.4");

    /**
     * True if this is Java 1.4.0_*.
     */
    public static final boolean IS_JAVA_1_4_0 = startsWith(
            JAVA_VERSION, "1.4.0");
     ...
     */
    public static final boolean IS_JAVA_5 = startsWith(JAVA_VERSION,
            "1.5");
     ...
     */
    public static final boolean IS_JAVA_6 = startsWith(JAVA_VERSION,
            "1.6");
     ...
     */
    public static final boolean IS_JAVA_6_OR_LATER = !IS_JAVA_1_4
            && !IS_JAVA_5;

    /**
     * True if this is Java 1.4 or Java 5.
     */
    public static final boolean IS_JAVA_1_4_OR_5 = IS_JAVA_1_4
            || IS_JAVA_5;
     ...
     */
    public static final boolean IS_OS_FREEBSD = startsWithIgnoreCase(
            OS_NAME, "FreeBSD");

    /**
     * True if this is Linux.
     */
    public static final boolean IS_OS_LINUX = startsWithIgnoreCase(
            OS_NAME, "Linux");
     ...
     */
    public static final boolean IS_OS_WINDOWS = startsWith(OS_NAME,
            "Windows");

    /**
     * True if this is Windows 98/ME/2000/XP/VISTA.
     */
    public static final boolean IS_OS_WINDOWS_MODERN = startsWith(
            OS_NAME, "Windows")
     ...
     * @since 2.0
     */
    public static final boolean IS_OS_WINDOWS_2000 = startsWith(
            OS_NAME, "Windows")
     ...
     * @since 2.0
     */
    public static final boolean IS_OS_WINDOWS_VISTA = startsWith(
            OS_NAME, "Windows")
     ...
     */
    public static final boolean IS_OS_SOLARIS = startsWith(OS_NAME,
            "Solaris");
    ...
    public static Color getSlightlyBrighter(Color color, float factor) {
        ...
        Color.RGBtoHSB(color.getRed(), color.getGreen(), color
                .getBlue(), hsbValues);
	...
	private Utils() {}
	public static String encodeTexts(String text) {
		if(text == null) return "";
		return text.replaceAll("\\|", "\\&pipe\\;");
	}
	public static String decodeText(String string) {
		return string.replaceAll("\\&pipe\\;", "\\|");
	}
	
	public static void main(String[] args) {
		String orig = "1|dds||\\$<>dasd$%^as|||dasd";
		System.out.println(orig);
		String encoded = encodeTexts(orig);
		System.out.println(encoded);
		System.out.println(decodeText(encoded));
	}

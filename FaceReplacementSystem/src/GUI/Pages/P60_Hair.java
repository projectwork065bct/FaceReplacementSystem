...
import GUI.Components.IOSUISlider;
...
public class P60_Hair extends RFPage {
    ...
    protected void createRightBtnsView() {
        ...
        //slider = new IOSUISlider(JSlider.HORIZONTAL, 1, 100, 50);

        IOSUIView thresholdTxtFieldView = new IOSUIView("95px", "50px");
        thresholdTxtFieldView.setBackground(Color.white);
        thresholdTxtFieldView.addXY(thresholdTxtField, 1, 1);
        thresholdBtn = new IOSUIButton(new AbstractAction("Set") {
        ...
        rightBtnsView.addXY(thresholdBtn, 1, 3);
